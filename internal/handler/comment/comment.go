...
func NewCommentHandler(svc commentservice.CommentService, requireModerationWrite bool) *CommentHandler {
	return &CommentHandler{svc: svc, requireModerationWrite: requireModerationWrite}
}
