...
const reviewRecordSelect = "moderation_item.id AS item_id, moderation_item.content_type, moderation_item.content_id, moderation_item.author_id, moderation_item.lock_version, moderation_item.lifecycle_state, moderation_item.public_state, moderation_item.materialized_revision_id, moderation_item.approved_revision_id, moderation_item.pending_revision_id, moderation_revision.id AS revision_id, moderation_revision.version AS revision_version, moderation_revision.submitted_content, moderation_revision.published_content, moderation_revision.risk_level, moderation_revision.policy_action, moderation_revision.review_status, moderation_revision.moment_status, moderation_revision.moment_comment_status, moderation_revision.created_at"
...
func mapReviewRecord(row reviewRecordRow) ReviewRecord {
	record := ReviewRecord{
		...
		State: ItemState{
			...
			Pending: revisionRef(row.PendingRevisionID),
		},
		...
		ReviewStatus: ReviewStatus(row.ReviewStatus), CreatedAt: row.CreatedAt,
	}
